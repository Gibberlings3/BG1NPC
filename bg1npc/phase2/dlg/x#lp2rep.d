...
== ~X#LP2REP~ IF ~InParty("garrick") InMyArea("garrick") !StateCheck("garrick",CD_STATE_NOTVALID) Global("X#GarrickRep","GLOBAL",2)~ THEN @35  DO ~IncrementGlobal("X#GarrickRep","GLOBAL",1)~ 
...
IF ~Class(Player1,PALADIN_ALL)~ THEN REPLY @98 DO ~SetGlobal("X#TroubadorRep","GLOBAL",1) SetGlobal("X#LakeP2RepTalk","GLOBAL",1)~ EXIT
...
+ ~PartyGoldGT(1499)~ + @117 DO ~TakePartyGold(1500) DestroyGold(1500) ReputationInc(-1)~ + X#Troubador2Final
END

IF ~~ THEN X#T2MB19.1
SAY @118
++ @116 + X#Troubador2NoCoin
+ ~PartyGoldGT(1199)~ + @117 DO ~TakePartyGold(1200) DestroyGold(1200) ReputationInc(-1)~ + X#Troubador2Final
END

IF ~~ THEN X#T2MB18.1
SAY @119
++ @116 + X#Troubador2NoCoin
+ ~PartyGoldGT(999)~ + @117 DO ~TakePartyGold(1000) DestroyGold(1000) ReputationInc(-1)~ + X#Troubador2Final
END

IF ~~ THEN X#T2MB17.1
SAY @120
++ @116 + X#Troubador2NoCoin
+ ~PartyGoldGT(499)~ + @117 DO ~TakePartyGold(500) DestroyGold(500) ReputationInc(-1)~ + X#Troubador2Final
END
...
SAY @122
++ @116 + X#Troubador2NoCoin
+ ~PartyGoldGT(399)~ + @117 DO ~TakePartyGold(400) DestroyGold(400) ReputationInc(-1)~ + X#Troubador2Final
END

IF ~~ THEN X#T2MB14.1
SAY @123
++ @116 + X#Troubador2NoCoin
+ ~PartyGoldGT(199)~ + @117 DO ~TakePartyGold(200) DestroyGold(200) ReputationInc(-1)~ + X#Troubador2Final
END

IF ~~ THEN X#T2MB13.1
SAY @124
++ @116 + X#Troubador2NoCoin
+ ~PartyGoldGT(299)~ + @117 DO ~TakePartyGold(300) DestroyGold(300) ReputationInc(-1)~ + X#Troubador2Final
END
...
SAY @127
++ @116 + X#Troubador2NoCoin
+ ~PartyGoldGT(699)~ + @117 DO ~TakePartyGold(700) DestroyGold(700) ReputationInc(-1)~ + X#Troubador2Final
END

IF ~~ THEN X#T2MB9.1
SAY @128
++ @116 + X#Troubador2NoCoin
+ ~PartyGoldGT(899)~ + @117 DO ~TakePartyGold(900) DestroyGold(900) ReputationInc(-1)~ + X#Troubador2Final
END
...
SAY @131
++ @116 + X#Troubador2NoCoin
+ ~PartyGoldGT(1999)~ + @117 DO ~TakePartyGold(2000) DestroyGold(2000) ReputationInc(-1)~ + X#Troubador2Final
END

IF ~~ THEN X#T2MB5.1
SAY @132
++ @116 + X#Troubador2NoCoin
+ ~PartyGoldGT(2499)~ + @117 DO ~TakePartyGold(2500) DestroyGold(2500) ReputationInc(-1)~ + X#Troubador2Final
END

IF ~~ THEN X#T2MB4.1
SAY @133
++ @116 + X#Troubador2NoCoin
+ ~PartyGoldGT(4999)~ + @117 DO ~TakePartyGold(5000) DestroyGold(5000) ReputationInc(-1)~ + X#Troubador2Final
END

IF ~~ THEN X#T2MB20.2
SAY @134
++ @116 + X#Troubador2NoCoin
+ ~PartyGoldGT(2399)~ + @117 DO ~TakePartyGold(2400) DestroyGold(2400) ReputationInc(-2)~ + X#Troubador2Final
END

IF ~~ THEN X#T2MB19.2
SAY @135
++ @116 + X#Troubador2NoCoin
+ ~PartyGoldGT(1899)~ + @117 DO ~TakePartyGold(1900) DestroyGold(1900) ReputationInc(-2)~ + X#Troubador2Final
END

IF ~~ THEN X#T2MB18.2
SAY @136
++ @116 + X#Troubador2NoCoin
+ ~PartyGoldGT(1299)~ + @117 DO ~TakePartyGold(1300) DestroyGold(1300) ReputationInc(-2)~ + X#Troubador2Final
END

IF ~~ THEN X#T2MB17.2
SAY @137
++ @116 + X#Troubador2NoCoin
+ ~PartyGoldGT(899)~ + @117 DO ~TakePartyGold(900) DestroyGold(900) ReputationInc(-2)~ + X#Troubador2Final
END

IF ~~ THEN X#T2MB16.2
SAY @138
++ @116 + X#Troubador2NoCoin
+ ~PartyGoldGT(799)~ + @117 DO ~TakePartyGold(800) DestroyGold(800) ReputationInc(-2)~ + X#Troubador2Final
END
...
SAY @139
++ @116 + X#Troubador2NoCoin
+ ~PartyGoldGT(499)~ + @117 DO ~TakePartyGold(500) DestroyGold(500) ReputationInc(-2)~ + X#Troubador2Final
END

IF ~~ THEN X#T2MB14.2
SAY @140
++ @116 + X#Troubador2NoCoin
+ ~PartyGoldGT(449)~ + @117 DO ~TakePartyGold(450) DestroyGold(450) ReputationInc(-2)~ + X#Troubador2Final
END

IF ~~ THEN X#T2MB13.2
SAY @141
++ @116 + X#Troubador2NoCoin
+ ~PartyGoldGT(599)~ + @117 DO ~TakePartyGold(600) DestroyGold(600) ReputationInc(-2)~ + X#Troubador2Final
END
...
SAY @143
++ @116 + X#Troubador2NoCoin
+ ~PartyGoldGT(999)~ + @117 DO ~TakePartyGold(1000) DestroyGold(1000) ReputationInc(-2)~ + X#Troubador2Final
END

IF ~~ THEN X#T2MB10.2
SAY @144
++ @116 + X#Troubador2NoCoin
+ ~PartyGoldGT(1399)~ + @117 DO ~TakePartyGold(1400) DestroyGold(1400) ReputationInc(-2)~ + X#Troubador2Final
END

IF ~~ THEN X#T2MB9.2
SAY @145
++ @116 + X#Troubador2NoCoin
+ ~PartyGoldGT(1799)~ + @117 DO ~TakePartyGold(1800) DestroyGold(1800) ReputationInc(-2)~ + X#Troubador2Final
END
...
SAY @147
++ @116 + X#Troubador2NoCoin
+ ~PartyGoldGT(2999)~ + @117 DO ~TakePartyGold(3000) DestroyGold(3000) ReputationInc(-2)~ + X#Troubador2Final
END

IF ~~ THEN X#T2MB6.2
SAY @148
++ @116 + X#Troubador2NoCoin
+ ~PartyGoldGT(3999)~ + @117 DO ~TakePartyGold(4000) DestroyGold(4000) ReputationInc(-2)~ + X#Troubador2Final
END

IF ~~ THEN X#T2MB5.2
SAY @149
++ @116 + X#Troubador2NoCoin
+ ~PartyGoldGT(6499)~ + @117 DO ~TakePartyGold(6500) DestroyGold(6500) ReputationInc(-2)~ + X#Troubador2Final
END

IF ~~ THEN X#T2MB20.3
SAY @150
++ @116 + X#Troubador2NoCoin
+ ~PartyGoldGT(2999)~ + @117 DO ~TakePartyGold(2800) DestroyGold(2800) ReputationInc(-3)~ + X#Troubador2Final
END

IF ~~ THEN X#T2MB19.3
SAY @132
++ @116 + X#Troubador2NoCoin
+ ~PartyGoldGT(2499)~ + @117 DO ~TakePartyGold(2500) DestroyGold(2500) ReputationInc(-3)~ + X#Troubador2Final
END

IF ~~ THEN X#T2MB18.3
SAY @131
++ @116 + X#Troubador2NoCoin
+ ~PartyGoldGT(1999)~ + @117 DO ~TakePartyGold(2000) DestroyGold(2000) ReputationInc(-3)~ + X#Troubador2Final
END

IF ~~ THEN X#T2MB17.3
SAY @151
++ @116 + X#Troubador2NoCoin
+ ~PartyGoldGT(1499)~ + @117 DO ~TakePartyGold(1500) DestroyGold(1500) ReputationInc(-3)~ + X#Troubador2Final
END

IF ~~ THEN X#T2MB16.3
SAY @138
++ @116 + X#Troubador2NoCoin
+ ~PartyGoldGT(799)~ + @117 DO ~TakePartyGold(800) DestroyGold(800) ReputationInc(-3)~ + X#Troubador2Final
END

IF ~~ THEN X#T2MB15.3
SAY @152
++ @116 + X#Troubador2NoCoin
+ ~PartyGoldGT(699)~ + @117 DO ~TakePartyGold(700) DestroyGold(700) ReputationInc(-3)~ + X#Troubador2Final
END
...
SAY @154
++ @116 + X#Troubador2NoCoin
+ ~PartyGoldGT(899)~ + @117 DO ~TakePartyGold(900) DestroyGold(900) ReputationInc(-3)~ + X#Troubador2Final
END

IF ~~ THEN X#T2MB12.3
SAY @155
++ @116 + X#Troubador2NoCoin
+ ~PartyGoldGT(1199)~ + @117 DO ~TakePartyGold(1200) DestroyGold(1200) ReputationInc(-3)~ + X#Troubador2Final
END

IF ~~ THEN X#T2MB11.3
SAY @156
++ @116 + X#Troubador2NoCoin
+ ~PartyGoldGT(1599)~ + @117 DO ~TakePartyGold(1600) DestroyGold(1600) ReputationInc(-3)~ + X#Troubador2Final
END

IF ~~ THEN X#T2MB10.3
SAY @157
++ @116 + X#Troubador2NoCoin
+ ~PartyGoldGT(2199)~ + @117 DO ~TakePartyGold(2200) DestroyGold(2200) ReputationInc(-3)~ + X#Troubador2Final
END

IF ~~ THEN X#T2MB9.3
SAY @158
++ @116 + X#Troubador2NoCoin
+ ~PartyGoldGT(2799)~ + @117 DO ~TakePartyGold(2800) DestroyGold(2800) ReputationInc(-3)~ + X#Troubador2Final
END

IF ~~ THEN X#T2MB8.3
SAY @159
++ @116 + X#Troubador2NoCoin
+ ~PartyGoldGT(3699)~ + @117 DO ~TakePartyGold(3700) DestroyGold(3700) ReputationInc(-3)~ + X#Troubador2Final
END

IF ~~ THEN X#T2MB7.3
SAY @160
++ @116 + X#Troubador2NoCoin
+ ~PartyGoldGT(3999)~ + @117 DO ~TakePartyGold(4000) DestroyGold(4000) ReputationInc(-3)~ + X#Troubador2Final
END

IF ~~ THEN X#T2MB6.3
SAY @161
++ @116 + X#Troubador2NoCoin
+ ~PartyGoldGT(7499)~ + @117 DO ~TakePartyGold(7500) DestroyGold(7500) ReputationInc(-3)~ + X#Troubador2Final
END
...
SAY @163
++ @116 + X#Troubador2NoCoin
+ ~PartyGoldGT(7499)~ + @117 DO ~TakePartyGold(7500) DestroyGold(7500) ReputationInc(-2)~ + X#Troubador2Final
END
