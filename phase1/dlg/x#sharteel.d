...
CHAIN IF WEIGHT #-1 ~%BGT_VAR% CombatCounter(0) InParty("tiax") Global("X#SHTI1","LOCALS",0) !See([ENEMY]) InParty(Myself) See("tiax") !StateCheck(Myself,CD_STATE_NOTVALID) !StateCheck("tiax",CD_STATE_NOTVALID)~ THEN ~%SHARTEEL_BANTER%~ SHTI1
@301
